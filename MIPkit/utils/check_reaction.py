...
def check_reaction(pargs):
    ...
    for fm in fms:
        if fm in fmavailabledic and fmavailabledic[fm] == 'vinyl':
            continue
        else:
            print(f'- Warning : According to the fm list, {fm} is not polymerizable via vinylization.\n')